...
resource messages, local-miss automatic search, complete-info gating, candidate
...
backing up the previous EXE; existing configuration/DLLs were not replaced.
Historical external service availability is not asserted.
