...
constexpr UINT kCmdToggleMainWindow = 32213; // 0x7dd5, 004A39EF
constexpr UINT kCmdOpaqueWhenActive = 0x7dd2;
constexpr UINT kCmdWindowShadow = 0x7dde;
...
constexpr UINT kCmdLyricEditorInsertWord = 0x90a0;
constexpr UINT kCmdLyricEditorReplaceWord = 0x90a1;
constexpr UINT kCmdLyricEditorDeleteWord = 0x90a2;
